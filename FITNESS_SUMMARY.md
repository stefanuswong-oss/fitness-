...
- **Scan did NOT happen Sat 29 Aug** (still travelling that weekend). Rescheduled to **Mon 31 Aug**. **He can only scan at the gym (~2 PM, post-lunch) and his standing habit is post-workout — keep it that way** (fasted/AM isn't possible and would break trend continuity). Monday is Push Strength = an upper-body day, so leg readings stay comparable. This is the Wk4/Wk5 checkpoint, now ~9 days later than the original 22 Aug plan date, so expect it to read softer than the 13.5% bf / 68.8 kg projection — it captures the full 21–27 Aug diet break plus a couple of maintenance days after. Offer a full re-projection once the numbers are in.
...
- **Scans: Mon 31 Aug · Tue 16 Sep · Sat 11 Oct · Mon 1 Dec.** The Aug scan moved
  22→29→31 Aug (still travelling each weekend) — scan at the gym after the Push Strength
  session (his usual post-workout / post-lunch state; do NOT switch to fasted/AM).
